  ...
  >
    <div class="relative flex flex-col gap-2 bg-ice p-10">
      ...
      <div>
        ...
        <div class="p-2">
          每位玩家放置各自的企鵝堆，置於遊戲區域外圍的其中一塊版塊。每位玩家由起始的版塊行動，
          將企鵝散播至其他區域。
        </div>
      </div>
      <div>
        ...
        <div class="p-2">
          輪到你時，你必須採取以下的動作
          <div class="p-2">
            <div>1.將你的企鵝堆分成兩堆(你可以決定每一堆企鵝的數量，但是每一堆中，至少有一隻羊)</div>
            <div>
              2.離開你的起始企鵝堆，直線移動你的新企鵝堆直到：
            </div>
            <div class="p-2">
              a)抵達其他的企鵝堆
              b)無法繼續往前走(抵達遊玩區域的邊緣)
